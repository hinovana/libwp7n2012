...
{
	public class HorseDamListView : UMAListView.UMAListViewTpl
	{
		...
		protected override Type[] ExtensionArgTypes {
			get {
				return new Type[] {
					...
					typeof(UInt32),
					typeof(KOEI.WP7_2012.Datastruct.HDamData),
				};
			}
		}
		...
		private void DataUpdateAndRefresh( int item_index, UInt32 horse_num, ref KOEI.WP7_2012.Datastruct.HDamData data )
		{
